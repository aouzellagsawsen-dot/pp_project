    ...
    <div className='flex justify-between flex-col items-center min-h-screen bg-[#f1ead7]'>
        ...
        <div className='bg-[#FAF6F0] rounded-2xl p-6 m-12 shadow-md my-auto flex'>
            <div className='grid grid-cols-4 gap-4'>
                ...
                <div className='rounded-xl col-span-2 flex'>
                    <Search className='w-5 h-5 text-[#7A6A5A]'></Search>
                    <input placeholder='Search by title or author...' type="text" className='bg-[#f8ecd0] placeholder:font-extralight placeholder:font-sans pl-1.5 focus:outline-none'/>
                </div>
