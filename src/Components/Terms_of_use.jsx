    ...
    <div className='bg-[#f1ead7] flex justify-center items-center min-h-screen'>
      ...
      <div className='absolute bottom-1 right-1 h-10 w-10 border-b border-r border-[#a88257]'></div>
            ...
            <div className='p-6 pl-px flex flex-col items-center text-left'>
              ...
              <h1 className='text-[#8B6A45] pb-10 font-[11px] pt-0.5 tracking-wider uppercase font-serif'>Republic of letters Alinéa</h1>
              ...
              <h1 className='text-[36px] font-serif font-extralight tracking-wider'>Terms of Use</h1>

              <h1 className='italic text-[#8B6A45] pb-7 pt-2 font-sans'>Of the charter that governs our literary community</h1>
                ...
                <div className='text-[#8B6A45] mb-10 italic w-full text-center px-4 text-[13px] font-sans'>Made in Bejaia, the seventeenth day of February, two thousand and twenty-six</div>
                <p className='ml-4 font-light italic leading-[1.80] font-sans'>
              ...
              <ol className='list-[upper-roman] flex gap-2 flex-col ml-8 space-y-4 list-outside'>
                    ...
                    <li className='marker:text-[#8B6A45] marker:font-light marker:text-lg pl-5 font-sans'>
                      <h1 className='mb-2.5'>Acceptance of terms</h1>
                      <p className='font-light'>By accessing Alinéa and using our services, you agree to be bound by these conditions. 
                    ...
                    <li className='marker:text-[#8B6A45] marker:font-light marker:text-lg pl-5 font-sans'>
                      <h1 className='mb-2.5'>Book Lending & Sharing</h1>
                      <p className='font-light'>Each member is responsible for the works they put into circulation. 
                    ...
                    <li className='marker:text-[#8B6A45] marker:font-light marker:text-lg pl-5 font-sans'>
                      <h1 className='mb-2.5'>Code of Conduct</h1>
                      <p className='font-light'>The Alinéa community is founded upon mutual respect. Any disrespectful, abusive, 
                    ...
                    <li className='marker:text-[#8B6A45] marker:font-light marker:text-lg pl-5 font-sans'>
                      <h1 className='mb-2.5'>Liability</h1>
                      <p className='font-light'>Alinéa is a platform connecting book enthusiasts. 
                    ...
                    <li className='marker:text-[#8B6A45] marker:font-light marker:text-lg pl-5 font-sans'>
                      <h1 className='mb-2.5'>Amendments</h1>
                      <p className='font-light'>We reserve the right to amend these conditions at any time. 
                    ...
                    <li className='marker:text-[#8B6A45] marker:font-light marker:text-lg pl-5 font-sans '>
                      <h1>Contact</h1>
                      <p className='font-light'>For any questions regarding these conditions, please do not hesitate to reach us through our dedicated contact page. 
            ...
            <div className="flex items-center justify-center gap-3 mb-4 w-full mt-10">
                  <div className="h-[1.5px] flex-1 bg-linear-to-r from-transparent via-[#8B6A45]/20 to-[#8B6A45]"/>
                  <span className="font-sans text-[#8B6A45] text-[18px] opacity-70">❦</span>
                  <div className="h-[1.5px] flex-1 bg-linear-to-l from-transparent via-[#8B6A45]/20 to-[#8B6A45]" />
              </div>  
            
            <div className='ml-8 italic mb-10 mt-3 flex flex-col gap-2'>
              ...
              <p className='font-sans font-light text-[#8B6A45]'>- The Alinéa Team</p>
             </div>
